...
################################################################################
output_folder = os.path.join(myroot,"model_chou1");
...
for pairid in paired['pairid'].unique():
    ...
    #     (mvc_results['s']**2)
    # ));
    result_set['k0'] = mvc_results['k0'];
    result_set['a'] = mvc_results['a'];
    result_set['k1'] = result_set['k0']*result_set['a'];
    ...
    t20_fitparams = model_t20_eq8.params.copy();
    t20_fitparams['k0'] = result_set['k0'];
    t20_fitparams['k1'] = result_set['k1'];
    t20_results, t20_r2 = model_t20_eq8.fit(
        t20_fit_sams['_time'],
    ...
    #     (t20_results['s']**2)
    # ));
    result_set['k2'] = t20_results['k2'];
    result_set['t20_r2'] = t20_r2;

    t20_predict = model_t20_eq8.predict(
        xpoints,
        *t20_results
    );
    # plot
    ...
    ax.text(1,1.08,
        str(
            "\n".join([
                ...
                "k0: "+str(np.round(result_set['k0'],4)),
                "k1: "+str(np.round(result_set['k1'],4)),
                "k2: "+str(np.round(result_set['k2'],4)),
